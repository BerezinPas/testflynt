...
/**
 * This is an example file showcasing how you can add custom Companys to your Flynt theme.
 *
...
add_action('init', function () {
    $labels = [
        'name'                  => _x('Companies', 'Company General Name', 'flynt'),
        'singular_name'         => _x('Company', 'Company Singular Name', 'flynt'),
        'menu_name'             => __('Companies', 'flynt'),
        'name_admin_bar'        => __('Company', 'flynt'),
    ...
    $args = [
        ...
        'description'           => __('Company Description', 'flynt'),
        'labels'                => $labels,
