...
export default function (el) {
  ...
  async function onLoadMore (e) {
    ...
    try {
      ...
      const posts = html.querySelector('flynt-component[name="SearchResults"] [data-ref="posts"]')
      const pagination = html.querySelector('flynt-component[name="SearchResults"] [data-ref="pagination"]')
